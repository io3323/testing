...
function t_popup__showPopup(e) {
  e && (e.style.display = "block"),
    setTimeout(function () {
      e.focus();
      let t = e ? e.querySelector(".t-popup__container") : null;
...
function t_popup__addClassOnTriggerButton(t, e) {
  let o = document.querySelectorAll(".t-popup__triggered-btn");
...
function t_popup__addFocusOnTriggerButton() {
  let t = document.querySelector(".t-popup__triggered-btn");
