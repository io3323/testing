(window.watchIn = window.watchIn || {}),
  (function () {
    function t_events__initEvent() {
        ...
        Array.prototype.forEach.call(btns, function (btn) {
          ...
          btn.querySelector("table") &&
            ...
            btn.addEventListener("click", function (e) {
              let currentUrl = e.target.getAttribute("href");
      ...
      let inputsAmount = document.querySelectorAll("input.js-amount");
      Array.prototype.forEach.call(inputsAmount, function (inputAmount) {
        let price = inputAmount.value;
    ...
    (watchIn.sendEcommerceEvent = function (type, productsArr) {
      ...
      (watchIn.sendEventToStatistics = function (
        ...
        let isVirtPage = "/" === virtPage.substring(0, 1),
          products = [],
          allRec,
          allRecFbSendEvent;
            ...
            if (isVirtPage)
              if (referer && referer.event)
                if ("purchase" === referer.event) {
                  for (
                    let products = referer.ecommerce.purchase.products,
                      delivery = 0,
                      i = 0;
                    i < products.length;
                    i++
              ...
              if (referer && referer.event)
                if (
                  ...
                  if (price > 0 && priceListID > 0) {
                    ...
                    for (
                      let iProduct = referer.ecommerce.purchase.products.length,
                        content_ids = [],
                        i = 0;
                      i < iProduct;
                      i++
                  ...
                  if (price > 0 && priceListID > 0) {
                    ...
                    eventParams.currency_code = currencyCode;
                    for (
                      let iProduct = referer.ecommerce.add.products.length,
                        content_ids = [],
                        i = 0;
                      i < iProduct;
                      i++
                  ...
                  if (price > 0 && priceListID > 0) {
                    ...
                    eventParams.currency_code = currencyCode;
                    for (
                      let iProduct = referer.ecommerce.detail.products.length,
                        content_ids = [],
                        i = 0;
                      i < iProduct;
                      i++
                  ...
                  if (price > 0 && priceListID > 0) {
                    ...
                    eventParams.currency_code = currencyCode;
                    for (
                      let iProduct = referer.ecommerce.remove.products.length,
                        content_ids = [],
                        i = 0;
                      i < iProduct;
                      i++
      ...
      (watchIn.saveUTM = function () {
        try {
          let watchInPageURL = window.location.href,
            watchInPageQuery = "",
            watchInPageUTM = "";
          if (
  ...
  Element.prototype.closest ||
    (Element.prototype.closest = function (s) {
      for (let el = this; el && 1 === el.nodeType; ) {
