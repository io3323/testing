!(function (e) {
  ...
  function u(e, r, n, i) {
    ...
    function f() {
      let e = "string" == typeof x.sL;
      if (e && !N[x.sL]) return t(E);
      let r = e ? u(x.sL, E, !0, C[x.sL]) : d(E, x.sL.length ? x.sL : void 0);
      return (
        x.r > 0 && (B += r.r),
        e && (C[x.sL] = r.top),
  ...
  function m(e) {
    ...
    if (!n(t)) {
      ...
      let a = r.textContent,
        ...
        l = c(r);
      if (l.length) {
        let m = document.createElementNS("http://www.w3.org/1999/xhtml", "div");
  ...
  return (
    ...
    e.registerLanguage("cs", function (e) {
      let t =
          "abstract as base bool break byte case catch char checked const continue decimal dynamic default delegate do double else enum event explicit extern false finally fixed float for foreach goto if implicit in int interface internal is lock long null when object operator out override params private protected public readonly ref sbyte sealed short sizeof stackalloc static string struct switch this true try typeof uint ulong unchecked unsafe ushort using virtual volatile void while async protected public private internal ascending descending from get group into join let orderby partial select set value let where yield",
        r = e.IR + "(<" + e.IR + ">)?";
      return {
        aliases: ["csharp"],
        k: t,
    ...
    e.registerLanguage("javascript", function (e) {
      return {
        ...
        k: {
          keyword:
            "in of if for while finally let new function do return void else break catch instanceof with throw case default try this switch continue typeof delete let yield const export super debugger as async await",
    ...
    e.registerLanguage("objectivec", function (e) {
      let t = { cN: "built_in", b: "(AV|CA|CF|CG|CI|MK|MP|NS|UI)\\w+" },
        r = {
          keyword:
    ...
    e.registerLanguage("php", function (e) {
      let t = { cN: "variable", b: "\\$+[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*" },
