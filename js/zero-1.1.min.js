function t396_init(e) {
  ...
  d &&
    ...
    window.addEventListener("load", function () {
      ...
      let t = d ? window.getComputedStyle(d).getPropertyValue("overflow") : "";
      "function" == typeof t_lazyload_update &&
        ...
        d.addEventListener(
          "scroll",
          t_throttle(function () {
            let t = i ? i.getAttribute("data-watchIn-lazy") : null;
            ("y" !== window.lazy && "yes" !== t) ||
...
function t396_doResize(t) {
  let e = t396_isOnlyScalableBrowser(),
  ...
  return (
    (t &&
      ...
      [document.body, t].reduce(function (t, e) {
        let i = window.getComputedStyle(e).paddingLeft,
...
let t396_waitForFinalEvent = (function () {
  let n = {};
...
function t396_artboard_build(t, e) {
  let i = document.getElementById("rec" + e),
    n = document.getElementById("allrecords"),
...
function t396__checkContainBackdropFilter(t) {
  if (!t) return !1;
  let e = window.getComputedStyle(t).webkitBackdropFilter;
...
function t396_elem__getFieldValue(t, e) {
  if ((t = t396_getEl(t))) {
    ...
    let i = t.closest(".t396__artboard"),
...
function t396_elem__renderView(e) {
  let t = (e = t396_getEl(e)) ? e.getAttribute("data-fields") : "";
  if (!t) return !1;
  (t = t.split(",")).forEach(function (t) {
...
function t396_group__renderView(i) {
  let t = i ? i.getAttribute("data-fields") : "";
  if (!t) return !1;
  (t = t.split(",")).forEach(function (t) {
    let e = t396_group__getFieldValue(i, t);
    switch (t) {
      case "left":
      ...
      switch (e) {
        ...
        case "width":
          switch (
            ...
            case "tooltip":
              let s = t.querySelectorAll(".tn-atom__pin-icon");
              Array.prototype.forEach.call(s, function (t) {
                let e = parseFloat(_).toFixed(1) + "px";
        ...
        case "container":
          ...
          break;
        case "inputs":
          let u = t.querySelector(".tn-atom__inputs-textarea"),
            _ = u ? u.value : "";
          try {
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  if ((t = t396_getEl(t))) {
    let n = t.closest(".t396__artboard"),
    ...
    switch (e) {
      case "left":
        ...
        if (
          ...
          let F = parseInt(t396_group__getFieldValue(p, "left"), 10);
          i -= F =
      ...
      case "top":
        ...
        let F = t.closest(".t396__artboard"),
...
function t396_ab__getFieldValue(t, e) {
  if (t) {
    let i = t.getAttribute("data-artboard-recid"),
      n = "ab" + i,
      o =
        (void 0 === window.tn[n] &&
          (t396_initTNobj(i, t),
...
function t396_ab__getHeight(t, e) {
  ...
  let t = t396_ab__getFieldValue(t, "height_vh");
  return (
    t &&
      ((t = parseFloat(t)),
