...
(function (e, t) {
  ...
  (x.fn = x.prototype =
    {
      ...
      pushStack: function (e) {
        let t = x.merge(this.constructor(), e);
    ...
    (function (e, t) {
      ...
      (s = at.isXML =
        ...
        (at.attr = function (e, n) {
          (e.ownerDocument || e) !== f && p(e);
          let i = o.attrHandle[n.toLowerCase()],
        ...
        (o = at.selectors =
          {
            ...
            filter: {
              TAG: function (e) {
                let t = e.replace(rt, it).toLowerCase();
                return "*" === e
                  ? function () {
                      return !0;
                    }
              ...
              return x
                .Deferred(function (n) {
                  x.each(t, function (t, o) {
                    ...
                    i[o[1]](function () {
                      let e = s && s.apply(this, arguments);
  ...
  x.extend({
    ...
    acceptData: function (e) {
      ...
      let t = e.nodeName && x.noData[e.nodeName.toLowerCase()];
  ...
  x.fn.extend({
    ...
    x.each(x.expr.match.bool.source.match(/\w+/g), function (e, n) {
      let r = x.expr.attrHandle[n] || x.find.attr;
      x.expr.attrHandle[n] =
        (K && Q) || !G.test(n)
          ? function (e, n, i) {
  ...
  x.extend({
    ...
    x.fn.extend({
      wrapAll: function (e) {
        ...
        if (this[0]) {
          let t = x(e, this[0].ownerDocument).eq(0).clone(!0);
  ...
  x.each({ Height: "height", Width: "width" }, function (e, n) {
    x.each(
      ...
      function (r, i) {
        x.fn[i] = function (i, o) {
          let a = arguments.length && (r || "boolean" != typeof i),
