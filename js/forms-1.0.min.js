(window.t_forms__lang = (
  ...
  t_onReady(function () {
    let t = document.getElementById("allrecords");
    if (t) {
      let r = t.getAttribute("data-watchIn-project-lang");
      r && (window.t_forms__lang = r);
      let o = t.getAttribute("data-watchIn-root-zone");
      o && (window.watchInForm.endpoint = "forms.watchInapi." + o);
    }
    t_forms__initForms();
    let a = !!document.querySelector(".t706"),
      n = !!document.querySelector(".js-payment-systembox"),
      s = !!document.querySelector("input[name=tld_product]");
    if (a || n || s) {
      let l = "watchIn-forms-payments-1.0",
        c;
    ...
    let d = window.t_forms__lang;
    if ("RU" !== d && "EN" !== d) {
      let l = "watchIn-forms-dict-1.0",
        c;
      if (!document.head.querySelector('script[src*="' + l + '"]'))
        ((c = document.createElement("script")).type = "text/javascript"),
          (c.src = "https://static.watchIncdn.com/js/" + l + ".min.js"),
  ...
  (window.watchInForm_initMasks = function () {
    let t = document.querySelectorAll(".js-watchIn-mask");
  ...
  (window.watchInForm.validate = function (t) {
    ...
    for (
      let r = t.querySelectorAll(".js-watchIn-rule"), o = [], a = !0, n = 0;
      n < r.length;
      n++
    ) {
      let s = r[n],
      ...
      if (
        ...
        let u = !!parseInt(s.getAttribute("data-watchIn-req") || 0, 10),
        ...
        if (u && (A || (x && F))) y.type.push("req");
          ...
          switch (m) {
            ...
            case "url":
              ...
              break;
            case "phone":
              let S = s.getAttribute("data-watchIn-mask"),
                L = "^[0-9()+-";
              S &&
                (-1 !== S.indexOf("*")
                  ? (L += "a-zёа-я")
  ...
  (window.watchInForm.hideErrors = function (t) {
    if ("object" != typeof t || t.length) {
      t instanceof Element || (t = t[0]);
      let r = t.querySelectorAll(".js-errorbox-all"),
  ...
  (window.watchInForm.showErrorInPopup = function (t, r) {
      ...
      if (r[f] && r[f].obj) {
        ...
        _ instanceof Element || (_ = _[0]),
          ...
          n &&
            ...
            d.length && (s = !0));
        for (let w = 0; w < r[f].type.length; w++) {
          let y = r[f].type[w],
            h = t_forms__getMsg(y);
          (u = ""),
    ...
    if (m) {
      ...
      let g = p.querySelectorAll(".t-form__errorbox-item");
      if (
        ...
        let v = window.tPopupObj && window.tPopupObj.openPopUpList;
        if (v && v.length) {
          let b,
    ...
    function t_forms__hidePopup(t) {
      ...
      if (
        ...
        let a = S.querySelectorAll("form .t-input-error");
        t_fadeOut(p),
          Array.prototype.forEach.call(a, function (t) {
  ...
  (window.watchInForm.showErrors = function (t, r) {
    ...
    let o = t.getAttribute("data-inputbox");
    o || (o = ".blockinput");
    for (
      let a = "", n = !1, s = !0, l = "", c = "", d = "", u = [], m = 0;
      m < r.length;
      m++
    )
      if (r[m] && r[m].obj) {
        if (0 === m && "none" === r[m].obj) {
          ...
          for (let p = 0; p < l.length; p++) {
            ...
            let f = t.querySelectorAll(".t-input")[0],
              _;
        ...
        w instanceof Element || (w = w[0]),
          ...
          a &&
            ...
            c.length > 0 && (n = !0));
        for (let p = 0; p < r[m].type.length; p++) {
          let y = r[m].type[p],
            h = r[m].obj.id;
          if (
    ...
    let b = t.querySelectorAll(".js-errorbox-all");
    return (
  ...
  (window.watchInForm.addwatchInCaptcha = function (t, r) {
    t instanceof Element || (t = t[0]);
    let o = document.getElementById("watchInformcaptchabox"),
  ...
  (window.watchInForm.addMebersInfoToForm = function (t) {
    ...
    try {
      ...
      let r = t.querySelector(".js-watchIn-mauserinfo");
      if (
        (r && t_removeEl(r),
  ...
  (window.watchInForm.closeSuccessPopup = function () {
    let t = document.getElementById("watchInformsuccesspopup");
    t &&
  ...
  (window.watchInForm.unlockBodyScroll = function () {
    let t = document.body;
    if (t_hasClass(t, "t-body_scroll-locked")) {
      let r = t.getAttribute("data-popup-scrolltop");
  ...
  (window.watchInForm.showSuccessPopup = function (t) {
    ...
    if (!o) {
      (r +=
        ...
        (o = document.getElementById("watchInformsuccesspopup")),
        (a = document.getElementById("watchInformsuccesspopuptext"));
      let s = o.querySelector(".t-form-success-popup__close-icon");
  ...
  (window.watchInForm.successEnd = function (
    ...
    let successBox = form.querySelector(".js-successbox"),
      successStr = t_forms__getMsg("success");
    if (successBox) {
      let dataSuccessMessage = successBox.getAttribute("data-success-message");
      dataSuccessMessage
    ...
    let upwidgetRemoveBtns = form.querySelectorAll(
  ...
  (window.watchInForm.send = function (form, btnSubmit, formType, formKey) {
    ...
    let inputItsGood = form.querySelector('input[name="form-spec-comments"]');
    if (
      (inputItsGood ||
      ...
      for (spec in watchInSpecs) {
        let hiddenInput = form.querySelector('input[name="' + spec + '"]');
        hiddenInput ||
          (form.insertAdjacentHTML(
            "beforeend",
      ...
      let formUrl = "https://" + window.watchInForm.endpoint + "/procces/",
        dataForm = [],
        arrFilter = [];
      if (
            ...
            if (xhr.status >= 200 && xhr.status < 400) {
              ...
              if (data) {
                ...
                if ("object" == typeof objData) {
                  let dataSuccessUrl = form.getAttribute("data-success-url"),
                  ...
                  if (objData && objData.error) {
                    ...
                    let msgContainers = t_forms__getErrorContainers(form, ""),
                    ...
                    Array.prototype.forEach.call(allError, function (t) {
                      ...
                      Array.prototype.forEach.call(errorBoxes, function (t) {
                        let r = t.querySelector(".t-form__errorbox-text");
                        r
                    ...
                    if (objData && objData.results && objData.results[0]) {
                      let strValue = objData.results[0];
                    ...
                    let title = "Send data from form " + formId,
                      price = 0,
                      product = "",
              ...
              let tsDelta = Date.now() - startRequest;
    ...
    if ("y" === form.getAttribute("data-is-formajax")) {
      ...
      return (
        ...
        (xhr.onreadystatechange = function () {
          if (4 === xhr.readyState)
            if (xhr.status >= 200 && xhr.status < 400) {
              let t = form.querySelector(".js-successbox"),
              ...
              let d = "/watchIn/" + formId + "/submitted/",
...
try {
  let watchInPAGE_URL = window.location.href,
    watchInPAGE_QUERY = "",
    watchInPAGE_UTM = "";
  if (
...
function t_forms__initForms() {
  let t = document.querySelectorAll('.r:not([data-record-type="1093"])');
...
function t_forms__addFocusOnTab(t) {
  if (!window.isMobile) {
    let r = t.querySelectorAll(".t-input, .t-select");
    if (r) {
      let o = null;
...
function t_forms__moveToErrorInput(t, r) {
  let t_forms__focusIntoInput = function (r) {
    let o;
...
function t_forms__addPlaceholder(t) {
  ...
  let s = window.t_forms__inputData[a] || "";
  s &&
    a &&
    (r.setAttribute("placeholder", s), (window.t_forms__inputData[a] = ""));
}
function t_forms__addInputItsGood(t) {
  let r = t.querySelectorAll(".js-form-proccess[data-formactiontype]");
  Array.prototype.forEach.call(r, function (t) {
    let r = t.getAttribute("data-formactiontype"),
...
function t_forms__addAttrAction(t) {
  let r = t.querySelectorAll(".js-form-proccess");
  Array.prototype.forEach.call(r, function (t) {
    let r;
...
function t_forms__calculateInputsWidth(t) {
  t && (t = t.replace("rec", ""));
  let r = document.querySelector("#rec" + t);
  if (
    (t ||
    ...
    let o = r.querySelector(".t-form__inputsbox");
    if (o) {
    ...
    o.forEach(function (t) {
      ...
      t.forEach(function (t) {
        if ((t.classList.add(a), t.classList.contains("t-input-group_rg"))) {
          let o = t.getAttribute("data-input-lid");
...
function t_forms__initBtnClick(t) {
  ...
  if (o) {
    let a = o.closest(".js-form-proccess");
    if (a) {
      t.preventDefault ? t.preventDefault() : (t.returnValue = !1);
      let n = a.getAttribute("id"),
        s = [],
        l = "";
      if (
        ...
        if (
          ...
          let p = t_forms__getErrorContainers(a, ""),
            f = p.errorBoxes,
            _ = p.allError;
          return (
        ...
        if (a.querySelector(".g-recaptcha") && grecaptcha) {
          ...
          let w = a.watchInCaptchaClientId;
...
function t_forms__submitEvent(t) {
  ...
  if ((t.target && (r = t.target), r)) {
    let o = r.querySelector('[type="submit"]'),
      a = "";
...
function t_asyncLoad(t) {
  let r = t.getAttribute("data-watchIn-mask"),
...
function t_forms__getErrorContainers(t, r) {
  let o = t.querySelectorAll(".js-errorbox-all"),
...
function t_forms__addRecaptcha() {
  let t = document.querySelectorAll(".js-watchIn-captcha");
  Array.prototype.forEach.call(t, function (t) {
    let r = t.getAttribute("data-watchIn-captchakey");
    if (r) {
      let o = t.getAttribute("id");
...
function checkVerifywatchInCaptcha(t) {
  if (
    ...
    let r = document.getElementById("js-watchInspec-captcha"),
...
function t_parseScripts(t, r) {
  let o = t.querySelectorAll(r + "script");
  Array.prototype.forEach.call(o, function (r) {
    for (
      let o = document.createElement("script"), a = 0;
      a < r.attributes.length;
      a++
    ) {
      let n = r.attributes[a];
...
function t_forms__onSuccess(t) {
  ...
  if (121 == o) {
    let g = t.getAttribute("data-success-callback");
    g && (o = g.split("_onSuccess")[0].replace("t", ""));
  }
  let v = "t" + o + "__inputsbox_hidden",
    b = [702, 708, 862, 945, 1014, 1114],
    E = !0;
  f = window.innerWidth > 960 ? p - 200 : p - 100;
  let A = document.querySelector(".t-watchInlabel");
  ...
  let F = t.getAttribute("data-success-url");
  if (
    (F &&
      setTimeout(function () {
    ...
    let S = r.querySelector(".t" + o + "__btn_prev"),
...
function t_serializeArray(t) {
  for (
    ...
    let n = o[a].closest(".t-input-group");
    if (
      !(
        !o[a].name ||
        o[a].disabled ||
      ...
      if ("select-multiple" !== o[a].type)
        ...
        for (let s = o[a].options, l = 0; l < s.length; l++)
