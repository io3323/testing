...
function t_animate__checkMobile(t) {
  return t.filter(function (t) {
    let e = t.closest(".t396__elem, .t396__group");
    return (
...
function t_animate__preventHorizontalScroll() {
  let t = document.querySelectorAll("[data-animate-style=fadeinleft]");
...
function t_animate__checkAnimationAvailability() {
  let t = document.querySelector(".t-records"),
...
function t_animate__generateStyles() {
  if (!!document.querySelector(".t396")) {
    for (
      let t = t_animate__getBreakpointsArr(),
        e =
      ...
      "IntersectionObserver" in window && !t
        ? (i.length &&
            ...
            i.forEach(function (t) {
              let e = t.querySelector(".t-animate");
            ...
            a.forEach(function (t) {
              let e = { rootMargin: (t.offsetHeight / 5) * -1 + "px 0px" };
          ...
          r.length &&
            ...
            window.addEventListener(
              "scroll",
              t_throttle(function () {
                let t = window.pageYOffset + window.innerHeight;
...
function t_animate__animateElems(t, a, n) {
  return (
    Array.prototype.filter.call(t, function (t) {
      let e = t_animate__detectElemTriggerOffset(t, a);
...
function t_animate__animateChainItemsOnScroll(t, e) {
  let a = t.querySelectorAll(".t-animate_wait[data-animate-chain=yes]"),
...
function t_animate__getSectionHeadDealy(t) {
  let e = t.querySelector(".t-section__title.t-animate"),
...
function t_animate__getDelayFromPreviousScrollEvent(t, e) {
  let a = !t.querySelectorAll(".t-animate_started").length,
...
function t_animate__setAnimELemsState(t, n, i) {
  t.forEach(function (t) {
    let e = t.getBoundingClientRect().top + window.pageYOffset;
    if (e < n - 500)
      return (
    ...
    let a = t_animate__detectElemTriggerOffset(t, i);
...
function t_animate__setGroupsBlocksState(t, i, r) {
  t.forEach(function (a) {
    let t = a.querySelectorAll(".t-animate"),
      t = Array.prototype.filter.call(t, function (t) {
...
function t_animate__setCustomAnimSettings(t, e, a) {
  let n = t_animate__getAttrByResBase(t, "style"),
...
function t_animate__detectElemTriggerOffset(t, e) {
  let t = t_animate__getAttrByResBase(t, "trigger-offset"),
    a = e;
  return (a = t ? e - +(t = t.replace("px", "")) : a);
}
function t_animate__saveSectionHeaderStartTime(t) {
  let e = t.querySelectorAll(".t-section__title.t-animate"),
    t = t.querySelectorAll(".t-section__descr.t-animate");
  e.length &&
    Array.prototype.forEach.call(e, function (t) {
...
function t_animate__makeSectionButtonWait(t) {
  let e = t.querySelectorAll(".t-animate[data-animate-chain=yes]").length,
...
function t_animate__checkSectionButtonAnimation__outOfTurn(t) {
  let e = t.querySelectorAll(".t-animate[data-animate-chain=yes]");
...
function t_animate__addNoHoverClassToBtns() {
  let t = document.querySelectorAll(".t-btn.t-animate");
  Array.prototype.forEach.call(t, function (t) {
...
function t_animate__removeNoHoverClassFromBtns(t) {
  if (!t) return !1;
  let e = t.classList.contains("t-btn") ? t : null;
  e &&
...
function t_animation__getZoom(t) {
  ...
  if (!t) return 1;
  let e = document.querySelector('script[src*="watchIn-blocks-2.7"]');
...
function t_animate__getChainOffsets(t) {
  t.forEach(function (a) {
    let t = a.querySelectorAll(".t-animate_wait[data-animate-chain=yes]");
    (a.itemsOffsets = []),
