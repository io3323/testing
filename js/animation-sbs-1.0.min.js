...
function t_animationSBS__wrapAndUpdateEls(t) {
  let l = -1 !== navigator.userAgent.indexOf("Chrome");
...
function t_animationSBS__updateStylesAfterWrapping(e, n, i) {
  let a = e.getAttribute("data-elem-type"),
...
function t_animationSBS__getAllBreakpoints() {
  ...
  return (
    t.forEach(function (t) {
      let t = t_animationSBS__getResOpts(t),
...
function t_animationSBS__createResizeObserver(n, i) {
  let a = document.body.getClientRects(),
    r = a[0].height;
...
function t_animationSBS__scrollAnimationCheckSteps(l, _, c) {
  _.steps.forEach(function (t, e) {
    let n = l.scrollTop + _.triggerOffset,
...
function t_animationSBS__generateKeyframes__getReverseAnim(t) {
  let e = t.classList.contains("tn-group"),
...
function t_animationSBS__getAnimOptions(e, t, n) {
  ...
  let i = t_animationSBS__generateAttr(a, n, r, o.res),
    l = e.getAttribute(i);
  return (
    l ||
...
function t_animationSBS__cacheAndSetData(n) {
  ...
  let t = n.elements.filter(function (t) {
    return (
      "innactive" === t.status &&
...
function t_animationSBS__generateUniqueIDForEl(t) {
  let e = t.closest(".t396__artboard, .tn-artboard"),
    n = "",
    e =
      (e &&
        (n =
...
function t_animationSBS__removeHoverClickTriggers(t) {
  let n = ["js-sbs-anim-trigger_click", "js-sbs-anim-trigger_hover"],
...
function t_animationSBS__initClickCallback() {
  let t = this["triggerList-on-click"] || [],
...
function t_animationSBS__initHoverTriggers(t) {
  let e = t.elements.filter(function (t) {
...
function t_animationSBS__connectTriggersWithAnimEls(t) {
  let a = t[0].getAttribute("data-animate-sbs-event");
...
function t_animationSBS__setIterationAnimation(t) {
  let e = t.target.closest(".t396__elem");
  if (e) {
    if ("loopwithreverse" === e.loop) {
      let n = t_animationSBS__getAnimationFullTime(e, !0);
...
function t_animationSBS__animationEndingEvent() {
  ...
  let t = this.getAttribute("data-planned-dir");
...
function t_animationSBS__playAnimation(e, t) {
  ...
  let n = t_animationSBS__getAnimationFullTime(e, !1),
...
function t_animationSBS__updateIntoViewElsState(t) {
  t &&
    t.length &&
    t.forEach(function (t) {
      let e = window.pageYOffset + t.triggerOffset,
        e =
          "blockintoview" === t.animType
            ? e >= t.parentRecTopPos
            : e >= t.topOffset,
...
function t_animationSBS__getZoom(t) {
  ...
  if (!t) return 1;
  let e = t.getAttribute("data-artboard-recid");
...
function t_animateSbs__wrapAtomEls() {
  let t = document.querySelectorAll("[data-animate-sbs-event]");
...
function t_animateSbs__reset(t) {
  for (let e = t.els, n = 0; n < e.length; n++) {
    let i = e[n].animType;
